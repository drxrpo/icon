...
class sources:
    ...
    def getSource_dialog(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, presetDict=[], timeout=30):
        ...
        print ("keltec SELFSCRAPERS",   self.__scrapers)
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.keltec.container.items'

        self.metaProperty = 'plugin.video.keltec.container.meta'
