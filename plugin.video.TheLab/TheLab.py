...
elif action == 'list1Navigator':
    from resources.lib.indexers import navigator
    navigator.navigator().list1()

elif action == 'list1liteNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().list1(lite=True)	

elif action == 'list1Movies':
    from resources.lib.indexers import navigator
    navigator.navigator().list1Movies()
	
elif action == 'list1Shows':
    from resources.lib.indexers import navigator
    navigator.navigator().list1Shows()
...
elif action == 'list3Navigator':
    from resources.lib.indexers import navigator
    navigator.navigator().list3()
	
elif action == 'list3liteNavigator':
    from resources.lib.indexers import navigator
    navigator.navigator().list3(lite=True)
