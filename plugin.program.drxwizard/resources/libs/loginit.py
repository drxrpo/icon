...
LOGINID = {
	...
	'limitless' : {
		'name'     : 'Limitless IPTV',
		'plugin'   : 'plugin.video.LimitlessIPTV',
		'saved'    : 'loginlimitless',
		'path'     : os.path.join(ADDONS, 'plugin.video.LimitlessIPTV'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.LimitlessIPTV', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.LimitlessIPTV', 'fanart.jpg'),
		'file'     : os.path.join(LOGINFOLD, 'limitless_login'),
		'settings' : os.path.join(ADDOND, 'plugin.video.LimitlessIPTV', 'settings.xml'),
		'default'  : 'Username',
		'data'     : ['Username', 'Password'],
		'activate' : ''},		
	'sportsaccess': {
	...
	'gearstv' : {
		...
		'file'     : os.path.join(LOGINFOLD, 'gearstv_login'),
	...
	'dextertv' : {
		...
		'file'     : os.path.join(LOGINFOLD, 'dextertv_login'),
		'settings' : os.path.join(ADDOND, 'plugin.video.dex', 'settings.xml'),
		'default'  : 'kasutajanimi',
		'data'     : ['kasutajanimi', 'salasona'],
		'activate' : ''},
	'vader' : {
		...
		'file'     : os.path.join(LOGINFOLD, 'vader_login'),
