...
INCLUDEBENELLI    = ADDON.getSetting('includebenelli')
INCLUDELOKI    = ADDON.getSetting('includeloki')
INCLUDEYODA    = ADDON.getSetting('includeyoda')
INCLUDEREPTILIA    = ADDON.getSetting('includereptilia')
...
def clearCache(over=None):
	...
	dbfiles   = [
		...
		(os.path.join(ADDOND, 'script.module.resolveurl', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.placenta', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.placenta', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.neptune', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.neptune', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.flixnet', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.flixnet', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.genesisreborn', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.genesisreborn', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.uranus', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.uranus', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.numbers', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.numbers', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.kratos', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.kratos', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.incursion', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.incursion', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.benelli', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.benelli', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.loki', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.loki', 'meta.db')),
		(os.path.join(ADDOND, 'plugin.video.Yoda', 'cache.db')),
		(os.path.join(ADDOND, 'plugin.video.Yoda', 'meta.db'))]
	...
	if INCLUDEVIDEO == 'true' and over == None:
		...
		if INCLUDEALL == 'true': files = dbfiles
			...
			if INCLUDESALTSHD == 'true': files.append(os.path.join(DATABASE,  'saltshd.lite.db')),
			if INCLUDEPLACENTA == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.placenta', 'cache.db')),
			if INCLUDEPLACENTA == 'true':	 files.append(os.path.join(ADDOND, 'plugin.video.placenta', 'meta.db')),
			if INCLUDENEPTUNE == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.neptune', 'cache.db')),
			if INCLUDENEPTUNE == 'true':	 files.append(os.path.join(ADDOND, 'plugin.video.neptune', 'meta.db')),
			if INCLUDEGENESISREBORN == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.genesisreborn', 'cache.db')),
			if INCLUDEGENESISREBORN == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.genesisreborn', 'meta.db')),
			if INCLUDEFLIXNET == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.flixnet', 'cache.db')),
			if INCLUDEFLIXNET == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.flixnet', 'meta.db')),
			if INCLUDEURANUS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.uranus', 'cache.db')),
			if INCLUDEURANUS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.uranus', 'meta.db')),
			if INCLUDENUMBERS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.numbers', 'cache.db')),
			if INCLUDENUMBERS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.numbers', 'meta.db')),
			if INCLUDEKRATOS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.kratos', 'cache.db')),
			if INCLUDEKRATOS == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.kratos', 'meta.db')),
			if INCLUDEINCURSION == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.incursion', 'cache.db')),
			if INCLUDEINCURSION == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.incursion', 'meta.db')),
			if INCLUDEBENELLI == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.benelli', 'cache.db')),
			if INCLUDEBENELLI == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.benelli', 'meta.db')),
			if INCLUDELOKI == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.loki', 'cache.db')),
			if INCLUDELOKI == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.loki', 'meta.db')),
			if INCLUDEYODA == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.Yoda', 'cache.db')),
			if INCLUDEYODA == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.Yoda', 'meta.db')),
			if INCLUDEREPTILIA == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.reptilia', 'cache.db')),
			if INCLUDEREPTILIA == 'true':  files.append(os.path.join(ADDOND, 'plugin.video.reptilia', 'meta.db'))
		if len(files) > 0:
			for item in files:
