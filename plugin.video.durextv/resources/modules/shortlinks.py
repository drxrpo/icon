...
def Get():
	...
	m3u  = 'http://root-hosting.ddns.net%3A25461%2Fget.php%3Fusername%3D'+username+'%26password%3D'+password+'%26type%3Dm3u_plus%26output%3Dts'
	epg  = 'http://root-hosting.ddns.net%3A25461%2Fxmltv.php%3Fusername%3D'+username+'%26password%3D'+password
	auth = 'http://root-hosting.ddns.net:25461/enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
