...
class yt_index:
    ...
    def init_vars(self, action):
        try:
            if action == 'fitness':
                self.action   = 'fitness'
                self.base_url = 'aHR0cDovL3Qyay1yZXBvc2l0b3J5Lm1sL0lUL0lUL3htbHMvZml0bmVzc3pvbmUv'.decode('base64')
                ...
                self.action   = 'legends'
                self.base_url = 'aHR0cDovL3Qyay1yZXBvc2l0b3J5Lm1sL0lUL0lUL3htbHMvbGVnZW5kcy9tZW51Lw=='.decode('base64')
