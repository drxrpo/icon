...
class navigator:
    ...
    NEWSFILE      = base64.b64decode(b'aHR0cHM6Ly93d3cudDJrLWNsb3VkLmNvLnVrL0tvZGkvdDJrL3doYXRzbmV3LnhtbA==')
    LOCALNEWS     = os.path.join(THISADDONPATH, 'whatsnew.txt')
    
    def root(self):
        
        porn = True if control.setting('porn_pw') == 'T2K Adults Only' else False
        if porn == True:
            self.addDirectoryItem('[B][COLOR pink]IT XXX[/COLOR][/B]', 'porn', 'tvshows.png', 'DefaultTVShows.png')
            self.addDirectoryItem('[B][COLOR pink]IT XXX 2[/COLOR][/B]', 'porn1', 'tvshows.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.docu') == True:
            self.addDirectoryItem(32631, 'docNav', 'documentaries.png', 'DefaultMovies.png')
...
#######################################################################
    def kids(self):
        self.addDirectoryItem('Animation', 'movies&url=https://api.trakt.tv/users/giladg/lists/animation/items', 'trakt.png', 'DefaultMovies.png')
        self.addDirectoryItem('Top 350 Cartoons of All-Time', 'tvshows&url=cartoons', 'cartoons.png', 'cartoons.png')
        ...
        self.addDirectoryItem('One Click Kids Movies', 'kids1', 'kids.png', 'kids.png')
        self.addDirectoryItem('Kids Corner', 'kids_random', 'kids.png', 'kids.png')
    ...
    def docs(self):
        self.addDirectoryItem('Top Documentaries', 'docuNavigator', 'documentaries.png', 'DefaultMovies.png')
        self.addDirectoryItem('Documentaries List', 'movies&url=https://api.trakt.tv/users/giladg/lists/latest-documentaries/items', 'trakt.png', 'DefaultMovies.png')

        self.endDirectory()

    def movies(self, lite=False):
        self.addDirectoryItem('[B][COLORred]IT Favorites[/COLOR][/B]', 'movies&url=it', 'featured.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Movies Lists', 'traktNav', 'trakt.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem('1 Click Movies (Real-Debrid Needed)', '1click', '1click.png', '1click.png')
        self.addDirectoryItem('1 Click Collections', '1clickcollections', '1click.png', '1click.png')
    ...
    def trakt_user(self):
        self.addDirectoryItem('Latest HD Releases', 'movies&url=https://api.trakt.tv/users/giladg/lists/latest-releases/items', 'trakt.png', 'DefaultMovies.png')
        self.addDirectoryItem('Latest 4K Releases', 'movies&url=https://api.trakt.tv/users/giladg/lists/latest-4k-releases/items', 'trakt.png', 'DefaultMovies.png')
        self.addDirectoryItem('Top 10 Movies of The Week', 'movies&url=https://api.trakt.tv/users/giladg/lists/top-10-movies-of-the-week/items', 'trakt.png', 'DefaultMovies.png')
        self.addDirectoryItem('Academy Award For Best Cinematography', 'movies&url=https://api.trakt.tv/users/giladg/lists/academy-award-for-best-cinematography/items', 'trakt.png', 'DefaultMovies.png')
        self.addDirectoryItem('Stand-up Comedy', 'movies&url=https://api.trakt.tv/users/giladg/lists/stand-up-comedy/items', 'trakt.png', 'DefaultMovies.png')
