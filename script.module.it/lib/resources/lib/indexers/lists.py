...
#please dont share link
    ...
    def root(self):
        try:
            regex.clear()
            url = 'JzY4NzQ3NDcwNzMzQTJGMkY3Nzc3NzcyRTc0MzI2QjJENjM2QzZGNzU2NDJFNjM2RjJFNzU2QjJGNEI2RjY0NjkyRjc0NjU3Mzc0MjUzMjMwNzg2RDZDMjUzMjMwNjY2OTZDNjU3MzJGNjM2QzZGNzc2RTczMkU3ODZENkMnLmRlY29kZSgnaGV4Jyk='.decode('base64.b64decode')
    ...
    def root_kids(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F677265792F6D61696E2E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_kids1(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F677265792F51434B55477A69442E747874'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_kids_random(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F696E64657865726B6964732E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_kids_dis1(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F6469736E65792E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_4k(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F5548442E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_1click(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F31253230436C69636B2532302832292E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_1clickcollections(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F31253230436C69636B2532302833292E786D6C'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_porn1(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7777772E74326B2D636C6F75642E636F2E756B2F4B6F64692F74657374253230786D6C25323066696C65732F43506F726E2E747874'.decode('hex')
            self.list = self.it_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
