...
##KIDS
        ...
        self.nic_link = 'https://www.imdb.com/search/title?keywords=Nickelodeon&sort=boxoffice_gross_us,asc'
        self.dis_link = 'https://www.imdb.com/search/title?title_type=tv_series,tv_episode,tv_special,tv_short&release_date=1999-01-01,&user_rating=5.0,&keywords=disney'
        self.cn_link = 'https://www.imdb.com/search/title?release_date=1999-01-01,&user_rating=5.0,&plot=cartoon+network'
