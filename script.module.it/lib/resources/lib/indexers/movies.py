...
class movies:
    def __init__(self):
        ...
        self.spotlight_link = 'https://www.imdb.com/list/ls049851220/?sort=user_rating,desc&st_dt=&mode=detail&page=1'
        self.it_link = 'https://www.imdb.com/list/ls016522954/?sort=user_rating,desc&st_dt=&mode=detail&page=1'
