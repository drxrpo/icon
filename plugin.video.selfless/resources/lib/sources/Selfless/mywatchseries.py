...
class source:
    def __init__(self):
        self.priority = 0
        self.language = ['en']
        self.domains = ['onwatchseries.to','mywatchseries.stream']
        self.base_link = 'https://w3.mywatchseries.stream/'
        self.search_link = 'https://w3.mywatchseries.stream/show/search-shows-json'
        self.search_link_2 = 'https://w3.mywatchseries.stream/search/%s'
