...
class sources:
    ...
    def getSources(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, presetDict=[], timeout=30):
        ...
        progressDialog.update(0, 'The kratoss working for You...')
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.kratos.container.items'

        self.metaProperty = 'plugin.video.kratos.container.meta'
