...
sysaddon         = base64.b64decode('cGx1Z2luOi8vcGx1Z2luLnZpZGVvLmtyYXRvcw==')
...
class navigator:
        def root(self):
                ...
                #self.addDirectoryItem('My kratos',       'lists_navigator',      'mymovies.png',      'DefaultRecentlyAddedMovies.png')
...
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
        ...
        def tools(self):
                ...
                self.addDirectoryItem('[B]kratos[/B]: Views', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]kratos[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]kratos[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]kratos[/B]: Clear Progress Database', 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
