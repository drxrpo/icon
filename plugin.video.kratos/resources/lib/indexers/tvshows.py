...
class tvshows:
    def __init__(self):
        ...
        self.tvdb_key             = base64.urlsafe_b64decode('MDYyOUI3ODVDRTU1MEM4RA==')
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if not tvdb == "0" or tvdb == None: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.kratos.q" % tvdb
                elif "tt" in imdb: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.kratos.q" % imdb
                else: sysmetalliq = "0"
