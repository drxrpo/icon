...
root_xml_url = "http://bit.ly/s3lfl3ss"  # url of the root xml file
__builtin__.tvdb_api_key = "A06CDA839FF29642"  # tvdb api key
__builtin__.tmdb_api_key = "b9b5e7ea541765974d447c51a66e8e57"  # tmdb api key
__builtin__.trakt_client_id = "5c0354a9eda7f5d9f222842ff4bc1204709c8d0675c63988f700a53e46c7e993"  # trakt client id
__builtin__.trakt_client_secret = "6b4fc97ab4dc5ec3458a03303c11f1cec164e7a45a3edbe006cba50334f3e087"  # trakt client secret
...
def root():
    ...
    if enable_newswin == 'true':
        koding.Add_Dir(name='[B][COLOR red]Latest[COLOR lime] News [COLOR yellow]And [COLOR cyan]Updates[/COLOR][/B]', url='{"my_text":"Latest News[CR]!!!","my_desc":""}', mode='dialog_example', folder=False, icon=os.path.join(art_path,'icon.png'), fanart=os.path.join(art_path,'fanart.jpg'))
