...
class podcast:
    ...
    def root(self):
        try:
            self.addDirectoryItem(32629, 'podbay', 'DefaultVideoPlaylists.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32624, 'podcastOne', 'DefaultVideoPlaylists.png', 'DefaultVideoPlaylists.png')
    ...
    def pco_root(self):
        try:
            self.addDirectoryItem(32625, 'podcastOne&podcastlist=featured-podcasts', 'DefaultVideoPlaylists.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32626, 'podcastOne&podcastlist=new-podcasts', 'DefaultVideoPlaylists.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32627, 'podcastOne&podcastcategories=list', 'DefaultVideoPlaylists.png', 'DefaultVideoPlaylists.png')       
            ...
            for i in cats: self.list.append(
                {
                    ...
                    'image': 'DefaultVideoPlaylists.png',
