...
def pairmenuoptions():
    ...
    call = dialog.select('[B][COLOR=yellow]Pair Links[/COLOR][/B]', [
    '[B][COLOR=red]            OpenLoad[/COLOR][/B]',
    '[B][COLOR=red]            Streamango[/COLOR][/B]',
    '[B][COLOR=red]            TheVideo[/COLOR][/B]',
    '[B][COLOR=red]            StreamCherry[/COLOR][/B]',
    '[B][COLOR=red]            VidUpMe[/COLOR][/B]',
    '[B][COLOR=purple]            Vevio[/COLOR][/B]',
    '[B][COLOR=purple]            vShare[/COLOR][/B]',
    '[B][COLOR=purple]            FlashX[/COLOR][/B]',
    '[B][COLOR=yellow]            Trakt SignUp[/COLOR][/B]',
    '[B][COLOR=yellow]            TMDB SignUp[/COLOR][/B]',
    '[B][COLOR=yellow]            IMDB SignUp[/COLOR][/B]',
    '[B][COLOR=yellow]            RealDebrid SignUp[/COLOR][/B]',
    '[B][COLOR=yellow]            Authorize RealDebrid[/COLOR][/B]',
    '[B][COLOR=green]            Cancel & Close[/COLOR][/B]',])
