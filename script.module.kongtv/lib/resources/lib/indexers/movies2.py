...
from resources.lib.modules import trakt,control,client,cache,metacache,playcount,workers,views,favourites
...
class movies:
    def __init__(self):
        ...
        self.imdb_by_query = 'http://www.omdbapi.com/?t=%s&y=%s&apikey=74703860'
        ...
        self.toprated_link = 'http://api.themoviedb.org/3/movie/top_rated?api_key=%s&page=1'
        ...
        self.tmdbjewmovies_link = 'http://api.themoviedb.org/3/list/101432api_key=%s' % (self.tmdb_key)
        self.tmdbjewtestmovies_link = 'http://api.themoviedb.org/3/list/97123?api_key=%s' % (self.tmdb_key)
        
        
        self.tmdbdcmovies_link = 'http://api.themoviedb.org/3/list/3?api_key=%s' % (self.tmdb_key)
        self.tmdbdcanimovies_link = 'http://api.themoviedb.org/3/list/62764?api_key=%s' % (self.tmdb_key)
        self.tmdbmarvelmovies_link = 'http://api.themoviedb.org/3/list/1?api_key=%s' % (self.tmdb_key)
        self.tmdbmarvelanimovies_link = 'http://api.themoviedb.org/3/list/62905?api_key=%s' % (self.tmdb_key)
        self.tmdbdisnemovies_link = 'http://api.themoviedb.org/3/list/11338?api_key=%s' % (self.tmdb_key)
        self.tmdbboxsetmovies_link = 'http://api.themoviedb.org/3/list/11549?api_key=%s' % (self.tmdb_key)
        self.tmdbbestpicwin_link = 'http://api.themoviedb.org/3/list/11334?api_key=%s' % (self.tmdb_key)
        ...
        self.tmdbdrugrel_link = 'http://api.themoviedb.org/3/list/36409?api_key=%s' % (self.tmdb_key)
        ...
        self.tmdbgangsters_link = 'http://api.themoviedb.org/3/list/36407?api_key=%s' % (self.tmdb_key)
        ...
        self.tmdbtruestory_link = 'http://api.themoviedb.org/3/list/40740?api_key=%s' % (self.tmdb_key)
        ...
        self.tmdbcharlottes_link = 'http://api.themoviedb.org/3/list/96168?api_key=%s' % (self.tmdb_key)
        ...
        ## Spare list?  self.tmdbhoney_link = 'http://api.themoviedb.org/3/list/16471?api_key=%s' % (self.tmdb_key)
        ...
        ## Spare list?  self.tmdbhunch_link = 'http://api.themoviedb.org/3/list/13237?api_key=%s' % (self.tmdb_key)
