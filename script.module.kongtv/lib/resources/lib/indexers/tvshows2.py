...
class tvshows:
    def __init__(self):
        ...
        self.tmdbjew250tv_link = 'http://api.themoviedb.org/3/list/86660?api_key=%s' % (self.tmdb_key)
        self.tmdbjewtestshows_link = 'http://api.themoviedb.org/3/list/97124?api_key=%s' % (self.tmdb_key)
        
        self.tmdbhuluorig_link = 'http://api.themoviedb.org/3/list/47716?api_key=%s' % (self.tmdb_key)
        self.tmdbnetflixorig_link = 'http://api.themoviedb.org/3/list/47713?api_key=%s' % (self.tmdb_key)
        self.tmdbamazonorig_link = 'http://api.themoviedb.org/3/list/47714?api_key=%s' % (self.tmdb_key)
