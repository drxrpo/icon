...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['fr']
        self.domains = ['filmstreaminghd.club','filmenstreaminghd.co']
        self.base_link = 'https://www.filmstreaminghd.club'
        self.key_link = '?'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            url = 'https://www.filmstreaminghd.club/recherche/'
            ...
            #r = sorted(set(r))
            url0 = '%s%s' % ('https://www.filmstreaminghd.club' , r)
            print url0
