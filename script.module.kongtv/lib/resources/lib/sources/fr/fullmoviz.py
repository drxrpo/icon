...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['fr']
        self.domains = ['zone-streaming.fr', 'fullmoviz.org']
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            #r = 'http://www.zone-streaming.fr/?s=deadpool'
            #r = client.request(r)
            ...
            query = 'http://www.zone-streaming.fr'
            r = client.request('http://www.zone-streaming.fr/?s=%s' % tq)
            print 'http://www.zone-streaming.fr/?s=%s' % tq
            r = client.parseDOM(r, 'div', attrs={'class': 'post-thumbnail'})
            ...
            r = client.request('http://www.zone-streaming.fr' + url)
            print 'http://www.zone-streaming.fr' + url
            r = client.parseDOM(r, 'div', attrs={'class': 'tab-me-content-wrapper'})
            r = client.parseDOM(r, 'iframe', ret='src')
            for i in r:
                url = i
