...
from resources.lib.modules import cleantitle,client,directstream,dom_parser,source_utils
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['ko']
        self.domains = ['dramacool9.io'] # Old  dramacool.su
        self.base_link = 'https://www11.dramacool9.io'
