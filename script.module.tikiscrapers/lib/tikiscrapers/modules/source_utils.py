...
from tikiscrapers.modules import pyaes
...
def limit_results(sources, limit=20):
    filteredSources = []
    filteredSources.extend([i for i in sources if i['quality'] == '4K'][:limit])
    filteredSources.extend([i for i in sources if i['quality'] == '1080p'][:limit])
    filteredSources.extend([i for i in sources if i['quality'] == '720p'][:limit])
    filteredSources.extend([i for i in sources if i['quality'] == 'SD'][:limit])
