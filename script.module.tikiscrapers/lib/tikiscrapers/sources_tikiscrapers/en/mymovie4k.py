# -*- coding: UTF-8 -*-
# -Cleaned and Checked on 03-22-2019 by JewBMX in Scrubs.

import re,urllib,urlparse
from tikiscrapers.modules import client,cleantitle,cache,dom_parser,source_utils
...
class source:
    def __init__(self):
        ...
        self._base_link = 'http://movie4k.pe' # or use... None
