    ...
    def process_item(self, item_xml):
        if "<sport_stream>" in item_xml:
            ...
            if "games" in item.get("sport_stream", ""):
                result_item = {
                    'label': item["title"],
                    'icon': "https://i.imgur.com/fcs0vg5.png",
...
def get_stream(url):
    ...
    try:
        ...
        xml += "<item>"\
               "<title>[B][I][COLOR yellow]Local Time  %s[/B][/I][/COLOR]</title>"\
               "<thumbnail>https://i.imgur.com/fcs0vg5.png</thumbnail>"\
               "<fanart>https://i.imgur.com/gDe5WVf.jpg</fanart>"\
               "<link></link>"\
               "</item>" % local_time
        try:
            ...
            xml += "<item>"\
                   "<title>[B][I][COLOR yellow]%s[/B][/I][/COLOR]</title>"\
                   "<thumbnail>https://i.imgur.com/fcs0vg5.png</thumbnail>"\
                   "<fanart>https://i.imgur.com/gDe5WVf.jpg</fanart>"\
                   "<link></link>"\
                   "</item>" % head1
