...
addon_id        = 'plugin.video.GearZ'
addon           = Addon(addon_id, sys.argv)
AddonTitle      = '[COLOR red]GearZ[/COLOR]'
...
baseurl         = base64 . b64decode ( b'aHR0cHM6Ly93d3cuZHJvcGJveC5jb20vcy85YW5qdzljYTZ6OGFmNmcvR2VhcloueG1sP3Jhdz10cnVl' )
...
messagetext     = base64 . b64decode ( b'aHR0cHM6Ly93d3cuZHJvcGJveC5jb20vcy9haTF1djEwMzZ3MWo3YzgvaW5mby54bWw/cmF3PXRydWU=') 
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][I][COLOR red]GearZ Version 1.0.4[/COLOR][/I][/B]', message)
...
def PLAYLINK(name,url,iconimage):
    ...
    dp.create(AddonTitle,"[COLORred]GearZ[/COLOR]",'[COLOR red]OPENING LINK[/COLOR]','')   
    dp.update(0)
