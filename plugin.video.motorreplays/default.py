...
baseurl         = 'http://theunjudged.xyz/Add-ons/Al/base.xml'
...
messagetext     ='http://theunjudged.xyz/Add-ons/Al/info.xml'
startinfo       ='http://theunjudged.xyz/Add-ons/Al/startinfo.xml'
...
def REDDIT_SUGGESTED():
    ...
    r = open_url('http://theunjudged.xyz/Add-ons/Al/suggested.xml')
...
def EVENT_REDDIT():
    ...
    r = open_url('http://theunjudged.xyz/Add-ons/Al/events.xml')
    r = re.compile('<link>(.+?)</link>').findall(r)
...
def SEARCH():
	...
	link=open_url('http://theunjudged.xyz/Add-ons/Al/search.xml')
