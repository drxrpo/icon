...
base_api_url = 'http://swiftstreamz.com/SwiftPanel/api.php?get_category'
base_dta_url = 'http://swiftstreamz.com/SwiftPanel/swiftlive.php'
base_cat_url = 'http://swiftstreamz.com/SwiftPanel/api.php?get_channels_by_cat_id=%s'
base_ico_url = 'http://swiftstreamz.com/SwiftPanel/images/thumbs/%s'
