...
ADDONTITLE     = '[COLOR steelblue]Hypersonic [COLOR white]IPTV2[/COLOR]'
...
def addDirMeta(name,url,mode,iconimage,fanart,description,year,cast,rating,runtime,genre):
	...
	liz.setProperty("IsPlayable","true")
	cm = []
	cm.append(('Play Trailer','XBMC.RunPlugin(plugin://plugin.video.hypersonicIPTV2/?mode=9&url='+str(name)+')'))
