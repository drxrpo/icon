...
#                print channel
                ...
                try:
                    ...
                    elif linkedUrl.startswith('tmdb=') and linkedUrl.endswith('=list'):
                        addDir(ChannelColor(name.encode('utf-8')),linkedUrl,500,thumbnail,fanArt,desc,genre,date,credits)
                    elif linkedUrl.startswith(('plugin://plugin.video.youtube/playlist/','https://www.youtube.com/playlist?list=')):
                    ...
                    elif linkedUrl.startswith('plugin://plugin') and not 'youtube/playlist' in linkedUrl:
                        BYB.plugintools.add_item(title=ChannelColor(name.encode('utf-8')),url=linkedUrl,thumbnail=thumbnail,fanart=fanArt,folder=True)
                    elif linkedUrl.startswith('plugin://script'):
                        BYB.plugintools.add_item(title=ChannelColor(name.encode('utf-8')),url=linkedUrl,thumbnail=thumbnail,fanart=fanArt,folder=True)
                    else:
