...
def CATEGORIES():
    addDir('Install','https://raw.githubusercontent.com/drxbld/fistofury/master/tissuebox.zip',1,install_icon,fanart_background,'Install addons and repos.')
...
def wizard(name,url,description):
    ...
    stringslink=OPEN_URL('https://raw.githubusercontent.com/drxbld/fistofury/master/strings.txt')
