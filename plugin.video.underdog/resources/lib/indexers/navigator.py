...
sysaddon         = base64.b64decode('cGx1Z2luOi8vcGx1Z2luLnZpZGVvLnVuZGVyZG9nLw==')
...
class navigator:
        def root(self):
                ...
                self.addDirectoryItem('My Underdog List',       'lists_navigator',      'mymovies.png',      'DefaultRecentlyAddedMovies.png')
...
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
        ...
        def mymovies(self):
                self.addDirectoryItem('Apollo\'s Race N Chase', 'movies&url=apollorace', 'apollo.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Apollo\'s War Path', 'movies&url=apollowar', 'war.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Clubber\'s Top Serial Killer Movies', 'movies&url=clubberskmovies', 'serialmov.jpg', 'DefaultMovies.png') 
                self.addDirectoryItem('Clubber\'s Action and Drama', 'movies&url=clubberaction', 'serialact.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Clubber\'s Latest Releases', 'movies&url=clubberlatest', 'clubcom.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Clubber\'s IMDB Top 250', 'movies&url=clubber250', 'clubcom.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Clubber\'s Comedies', 'movies&url=clubbercomedy', 'clubcom.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Clubber\'s Sports Movies', 'movies&url=clubbersports', 'mymovies.png', 'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem('Creed\'s Prime Movies', 'movies&url=creedmovie', 'creedprime.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Thunder\'s Thrillers Round Deux', 'movies&url=thunder', 'deux.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Thunder\'s Newer Horrors', 'movies&url=newhorror', 'newer.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Thunder\'s Disturbia', 'movies&url=disturbia', 'disturb.jpg', 'DefaultMovies.png')
                self.addDirectoryItem('Thunder\'s Super Hero Movies', 'movies&url=thunderheroes', 'hero.png', 'DefaultMovies.png')
                self.addDirectoryItem('Thunder\'s Uabhas', 'movies&url=thunderuabahs', 'fit.png', 'DefaultMovies.png')
                self.addDirectoryItem('Tommy Gunn\'s Netflix Movies', 'movies&url=supnet', 'flixgun.jpg', 'DefaultMovies.png')
        ...
        def mytv(self):
                self.addDirectoryItem('Clubber\'s Killer TV Shows', 'movies&url=clubberkillertv', 'clubcom.jpg', 'DefaultMovies.png')
        ...
        def tools(self):
                self.addDirectoryItem('[B]URL RESOLVER[/B]: Settings', 'resolveurlsettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]SETTINGS[/B]: Providers', 'underdogscrapersettings&query=1.1', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]underdog[/B]: Views', 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]underdog[/B]: Clear Providers', 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem('[B]underdog[/B]: Clear Cache', 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem('[B]underdog[/B]: Clear Progress Database', 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
