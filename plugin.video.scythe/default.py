...
Pass = plugintools.get_setting("Password")

if Email == "" :
    xbmcgui.Dialog().ok("[B][COLOR darkorange]Scythe[/COLOR][/B]", "You are required to login to use [B][COLOR darkorange]Scythe[/COLOR][/B]!", "Please enter your login details at the next prompt.","To sign up visit - [COLOR darkorange]www.sandmanmedia.xyz/members[/COLOR] - You must be a member of our Telegram group and confirm your email with an admin!")
...
def AUTHENTICATE():
    DATA_SETTINGS_FILE   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.scythe/settings.xml'))
    ...
    if not base64.b64decode('MQ==') in data:
		...
		dialog.ok('[B][COLOR darkorange]Scythe[/COLOR][/B]', "[COLOR red][B]Error:[/B][/COLOR] You have not entered a valid E-Mail and Password.")
		plugintools.open_settings_dialog()	
		sys.exit(0)
