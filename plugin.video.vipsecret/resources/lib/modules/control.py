...
def artPath():
    path = xbmc.translatePath('special://home/addons/plugin.video.vipsecret/')
    return path
...
def metaFile():
    path = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.vipsecret/meta')
    return path
