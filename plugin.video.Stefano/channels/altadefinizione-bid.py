...
__channel__ = "altadefinizione-bid"
host = "https://altadefinizione.pics"
headers     = [['Referer', host]]


def mainlist(item):
    logger.info("[stefano addon altadefinizione-bid] mainlist")
...
def categorias(item):
    logger.info("[Stefano Addon altadefinizione-bid] categorias")
    itemlist = []
...
def search(item, texto):
    logger.info("[Stefano Addon altadefinizione-bid] " + item.url + " search " + texto)
...
def peliculas(item):
    logger.info("[Stefano Addon altadefinizione-bid] peliculas")
    itemlist = []
...
def peliculas_tv(item):
    logger.info("[Stefano Addon altadefinizione-bid] peliculas_tv")
    itemlist = []
...
def peliculas_tv_new(item):
    logger.info("[Stefano Addon altadefinizione-bid] peliculas_tv_new")
    itemlist = []
    PERPAGE = 14
...
def peliculas_ep(item):
    logger.info("[Stefano Addon altadefinizione-bid] peliculas_ep")
    itemlist = []
    minpage = 14
...
def episodios(item):
    ...
    logger.info("[Stefano Addon altadefinizione-bid] episodios")
    itemlist = []
...
def findvideos_tv(item):
    logger.info("[Stefano Addon altadefinizione-bid] findvideos_tv")
    itemlist = []
...
def findvideos_movies(item):
    logger.info("[Stefano Addon altadefinizione-bid] findvideos_movies")
    itemlist = []
...
"""
def findvideos(item):
    logger.info("Stefano Addon altadefinizione-bid findvideos")
