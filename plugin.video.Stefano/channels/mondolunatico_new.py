...
def mainlist(item):
    logger.info("Stefano.istreaming mainlist")
...
def pelis_movie_src(item):
    logger.info("Stefano.mondolunatico_new peliculas")
...
def findvideos_x(item):
    logger.info("Stefano.mondolunatico findvideos")
