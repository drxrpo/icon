...
@plugin.route('/')
def root():
    categories = {"01": "[COLOR red]UK & USA Channels[/COLOR]",
                  "02": "[COLOR red]Movies[/COLOR]",
                  "03": "[COLOR red]Music[/COLOR]",
                  "04": "[COLOR red]News[/COLOR]",
                  "05": "[COLOR red]Sport[/COLOR]",
                  "06": "[COLOR red]Documentary[/COLOR]",
                  "07": "[COLOR red]Kids[/COLOR]",
                  "08": "[COLOR red]Food[/COLOR]",
                  "09": "[COLOR red]Religious[/COLOR]"}
    list_items = []
