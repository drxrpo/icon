...
I1IiI = 'plugin.module.Stesport'
o0OOO = Addon ( I1IiI , sys . argv )
iIiiiI = xbmcaddon . Addon ( id = I1IiI )
Iii1ii1II11i = '[COLOR orange][B]Sports Scraping[/B][/COLOR]'
iI111iI = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.module.Stesport' )
IiII = xbmc . translatePath ( os . path . join ( 'special://home/addons/' + I1IiI , 'fanart.gif' ) )
iI1Ii11111iIi = xbmc . translatePath ( os . path . join ( 'special://home/addons/' + I1IiI , 'fanart.gif' ) )
