...
iI1Ii11111iIi = xbmc.translatePath("special://profile/addon_data/%s/speedtest/" % I1IiI)
import shutil
try: shutil.rmtree(iI1Ii11111iIi)
except: pass
...
class oO(xbmcgui.Window):
    def __init__(self):
        ...
        self.image_dir = xbmc.translatePath(os.path.join(script_path, 'images'))
...
if __name__ == '__main__':
    ...
    oO0o00ooO = oO0ooOO('main.xml', script_path, 'Default')
