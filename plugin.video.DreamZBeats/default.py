...
baseurl         = base64 . b64decode ( b'aHR0cHM6Ly93d3cuZHJvcGJveC5jb20vcy9jMDNpcTU3OWtncGxyMGcvRHJlYW1aQmVhdHMueG1sP3Jhdz10cnVl' )
...
messagetext     = base64 . b64decode ( b'aHR0cHM6Ly93d3cuZHJvcGJveC5jb20vcy92ZG5qYnozenQxMXozNWsvaW5mby54bWw/cmF3PXRydWU=') 
...
def popup():
        ...
        if len(message)>1:
                ...
                if compfile == message:pass
                        ...
                        showText('[B][I][COLOR magenta]DreamZBeats Version 1.0.6[/COLOR][/I][/B]', message)
