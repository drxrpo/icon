...
app_signature = str(0x28781949c)  # 0xd43b3efa 0x17cab638a 0x7007c21c
...
def get_lb_media_url(relayer):
    ...
    headers = [
        ...
        a2b_hex("582d5265717565737465642d576974683d322e312e3134253230467265656d69756d").decode("utf-8"),
    ]
